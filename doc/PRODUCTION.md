###Neurovault Puppet Production Install

1. Before you begin, create a server or VM with __Ubuntu 14 Server 64-bit__.  You don't need to manually install any software on your system or VM, except `openssh-server`, and any software specific to your network or organization.
 
Configure host name and networking.  Perform server hardening for your environment as needed, including a packet filter.  Best practices for server security are outside the scope of this installation tool.
...
2. Install the Puppet and Git packages, and update your operating system:
...
You will now have a live NeuroVault installation at the location you've chosen.  By default, you can navigate to "http://neurovault-dev.local", but typically a real FQDN will of course be used. The application will be located under `/opt/nv-env`, or the location you've chosen.
